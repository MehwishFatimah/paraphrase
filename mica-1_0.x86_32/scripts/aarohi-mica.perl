...
my $SuperTagger   = "taggers/SuperTagger.sh";
my $Parser        = "./parser/mica_parser-1_0.x86_32";
my $StagBeamer    = "scripts/stag_beamer.perl";
my $Postprocessor = "postprocessor/add-tree-info.perl";
my $Tokenizer     = "tokenizer/divide-punct2.perl";
